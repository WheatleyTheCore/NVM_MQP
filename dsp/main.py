                    ...
                    for variant in data_conf['variants']:
                        for volume in data_conf['volumes']:
                            ...
                            def compute_ir_with_data(mapping):
                                ...
                                chord_similarity_inverse_filtering = compute_MFCC_similarity_dtw(generated_chord_inverse_filtering, target_chords[target_type])
                                chord_similarity_weiner = compute_MFCC_similarity_dtw(generated_chord_weiner, target_chords[target_type])
                                chord_similarity_acdw = compute_MFCC_similarity_dtw(generated_chord_acdw, target_chords[target_type])
                                ...
                                melody_similarity_inverse_filtering = compute_MFCC_similarity_dtw(generated_melody_inverse_filtering, target_melodies[target_type])
                                melody_similarity_weiner = compute_MFCC_similarity_dtw(generated_melody_weiner, target_melodies[target_type])
                                melody_similarity_acdw = compute_MFCC_similarity_dtw(generated_melody_acdw, target_melodies[target_type])
